...
const Signup = () => {
  ...
  return (
    <div className='bg-zinc-500 h-[calc(100vh-5rem)] w-full flex flex-col justify-center items-center'>
      <h4 className='mb-3 text-black'>Sign up and keep your favorite movies!</h4>
      <form className=' rounded-lg p-8 w-1/3' onSubmit={handleSubmit(onSubmit)}>
        <input
          type='text'
          placeholder='email'
        ...
        />
        {errors.username && <p className='text-red-900' role="alert">{errors.username.message}</p>}
        ...
        <input
          ...
          className='w-full rounded mb-3 p-2'
          {...register('confirm', {
            minLength: { value: 4, message: 'Confirm password should have at least 4 characters' },
